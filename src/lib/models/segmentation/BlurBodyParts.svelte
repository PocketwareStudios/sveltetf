...
<script lang="ts">
  ...
  export let image: HTMLImageElement | HTMLVideoElement | HTMLCanvasElement | OffscreenCanvas; // ImageData|HTMLImageElement|HTMLCanvasElement|HTMLVideoElement
  ...
  async function performSegmentation(_image: HTMLImageElement | HTMLVideoElement | HTMLCanvasElement | OffscreenCanvas) {
